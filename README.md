...
**Текущая реализация.** Ветер, дождь, облачность, температура, давление и диапазон −24…+24 часа связаны с одной почасовой выборкой. Дождь встречает найденные горизонтальные плоскости комнаты (plane detection), в точке падения расходится кольцо-всплеск; без плоскостей он честно падает на пол. HUD доступен на телефоне и десктопе, в XR тот же ряд вынесен в пространственное управление.
...
**Текущая реализация.** Есть настольный и 360° режимы, геолокация, выбор точки лучом, манипулируемая карточка, кнопка радиуса и тот же масштаб двумя руками в XR. В выборку входят культурные места, памятники, кафе, образование и другие именованные POI; данные не маскируются под готовый город — визуальный язык остаётся абстрактной орбитальной схемой.
